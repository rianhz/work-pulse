...
import { LEAVE_TYPE_ANNUAL_LEAVE, LEAVE_TYPE_SICK_LEAVE, LEAVE_TYPE_MATERNITY_LEAVE, LEAVE_TYPE_PATERNITY_LEAVE, LEAVE_TYPE_PERIOD_LEAVE, LEAVE_TYPE_MARRIAGE_LEAVE, LEAVE_TYPE_UNPAID_LEAVE, LEAVE_TYPE_HOURS_ADJUSTMENT, STATUS_AWAITING_APPROVAL } from '../../../utils/constant';
...
const LeaveRequestSchema = new Schema(
  {
    ...
    status: {
      type: String,
      enum: [STATUS_PENDING, STATUS_APPROVED, STATUS_REJECTED, STATUS_CANCELLED, STATUS_AWAITING_APPROVAL],
      default: STATUS_AWAITING_APPROVAL,
    },
