...
const EmblaCarousel = (props: PropType) => {
  const { children, options, showArrowButton = true, showDotButton = true } = props
      ...
      {showArrowButton && (
        <>
          <PrevButton 
            ...
            className="opacity-50 group-hover:opacity-100 transition-all duration-300 absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-white/80 hover:bg-white p-2 rounded-full shadow-md transition-all disabled:opacity-40 disabled:cursor-not-allowed" 
          />
          <NextButton 
